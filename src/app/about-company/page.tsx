        ...
        <div>
          ...
          <div className="flex flex-col items-center justify-between md:flex-row">
            <div className="order-2 w-[100%] max-w-[430px] md:order-none lg:max-w-[500px]">
              ...
              <br />
              <p>
                We have a completely new, innovative reward system that will
                allow each partner to feel the delights and advantages of a
                network business from the very first steps. We have created
                special loyalty programs to support both young and experienced
                MLM entrepreneurs.
              </p>
            </div>
            <Image
